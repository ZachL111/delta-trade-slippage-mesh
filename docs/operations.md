...
`delta-trade-slippage-mesh` is centered on trading systems work in Zig. The technical target is: Design a Zig verification harness for slippage systems, covering stream reduction, windowed input fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 156. Risk has a penalty of 6, latency has a penalty of 3, and weight contributes a bonus of 4.
